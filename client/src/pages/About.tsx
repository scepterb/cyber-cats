    ...
    <>
      <div className="page-content subpage-left-align">
        ...
        <p className="margin-bottom">
          ...
          I know that sounds exaggerated, but you will soon realize that just the mere fact of making your computer do something awesome and getting a secret flag will generate raw excitement and adrenaline.
          Join us as we try to harness the mind-numbing power of computers.
        </p>
        <h2 className="typing">More specifically...</h2>
        <p>
          ...
          All of this builds up to us competing in <Link to="https://ctf101.org/intro/what-is-a-ctf/">capture-the-flags</Link>, which are timed hacking competitions (they look great on college resumes!)
        </p>
      </div>
    </>
  );
