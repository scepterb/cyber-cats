  ...
  return (
    <>
      <div className="page-content subpage-left-align">
        ...
        <p>
          Those who can't download VSCode or access the terminal on their personal device should create a GitHub codespace with <TooltipLink href="https://github.com/codespaces/new?repo=scepterb/hack-cats-codespace" tooltip="github.com" target="_blank">this link</TooltipLink>.
          ...
          <em>GitHub codespaces</em> are basically a cloud computer running VSCode for you. We'll use it to write code and connect to remote computers.
        </p>
        <p>
